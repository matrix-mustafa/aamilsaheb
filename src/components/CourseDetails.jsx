...
export default function CourseDetails({course, institute, jawab, period, title, startDate, endDate})
{
    const openJawab = url => {
    ...
    let courseDate = (startDate !== '0000-00-00' && endDate !== '0000-00-00') ? `From: ${startDate} To: ${endDate}` : ''
    return (
        <div className={`user-courses-container ${period}`}>
            ...
            <div className='course-container'>
                ...
                { courseDate && <div className='course-text'>{courseDate}</div> }
            </div>
            {jawab !== "" ?
